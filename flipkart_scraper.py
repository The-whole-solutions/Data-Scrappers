...
class FlipkartScraper:
    ...
    def scrap_result_row(self, div):
        ...
        try:
            ...
            print  ('[FlipkartScraper] :: price . . . . . :', price.encode("utf-8"))

            self.mdb.flipkart_scrapper_data(title, sub_rating, specifications, price)

            fname = 'data_flipkart.csv'
            msg = "%s, %s, %s, %s," % (title, sub_rating, specifications, price.encode("utf-8"))
...
if __name__ == '__main__':
    flipkart_scraper_data = FlipkartScraper('android smartphones')
    flipkart_scraper_data.run()
